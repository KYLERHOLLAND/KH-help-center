...
26 handcrafted film LUTs for cinematic color grading — 13 Standard (Rec.709) and 13 matched Log versions. Includes `.cube` files and a Premiere Pro preset file.

**Get the product:** [Film Luts](https://www.kylerholland.com/film-luts)  
...
| Item | Description |
|------|-------------|
| 13 Standard LUTs | For Rec.709 / standard color space footage |
| 13 Log LUTs | Matched versions for Log profiles |
| Premiere Pro preset | Import via the Effects panel for one-click LUT access |
| `.cube` files | Compatible with Premiere Pro, DaVinci Resolve, Final Cut Pro, and more |

Works with Sony, Canon, Panasonic, RED, Blackmagic, and most other cameras.

---

## How to use

1. Choose **Standard** LUTs for Rec.709 footage or **Log** LUTs when shooting in a Log profile.
2. Apply via the imported Premiere preset or load a `.cube` file in Lumetri Color.
3. Adjust **Intensity** to taste — most looks need minimal tweaking after application.
